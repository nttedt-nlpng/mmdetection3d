...
from mmdet.models import AnchorFreeHead, MaskFormerHead


@MODELS.register_module()
class Mask2FormerNusOccHead(MaskFormerHead):
    """ (Modified)Implements the Mask2Former head.
    ...
    def forward(self, x: List[Tensor],
        ...
        '''
        self.pixel_decoder skipped ...
        '''
        # mask_features, multi_scale_memorys = self.pixel_decoder(x)
        mask_features = x[0]
        multi_scale_memorys = x[:0:-1]
