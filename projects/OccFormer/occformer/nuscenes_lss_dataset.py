...
class CustomNuScenesLSSDataset(NuScenesDataset):
    ...
    def evaluate_lidarseg(self, results, logger=None, **kwargs):
        from projects.OccFormer.occformer.utils import (
    ...
    def evaluate_ssc(self, results, logger=None, **kwargs):
        # though supported, it can only be evaluated by
        # the sparse-LiDAR-generated occupancy in nusc
        ...
        class_names = ['empty', 'barrier', 'bicycle', 'bus', 'car',
                       ...
                       'truck', 'driveable_surface', 'other_flat',
        ...
        eval_results['nuScenes_combined_IoU'] = eval_results['nuScenes_SC_IoU'] + \
            eval_results['nuScenes_SSC_mIoU']
